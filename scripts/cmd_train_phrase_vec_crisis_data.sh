...
$HOME/tools/word2vec/bin/word2vec -train $phrase1 -output $w2vFile -cbow 0 -size 300 -window 6 -alpha 0.025 -negative 5 -hs 1 -sample 1e-4 -threads 40 -binary 0 -iter 15 -min-count 5 -save-vocab $vocabFile
